...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    ...["timeline","search","compare","tools","trends","quiz","today","bookmarks","ai","following","people","history-today","dashboard","engine"].map((path) => ({ url: `${base}/${path}`, lastModified: new Date() })),
    ...entries.map((entry) => ({
